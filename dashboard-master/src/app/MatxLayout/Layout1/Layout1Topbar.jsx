...
class Layout1Topbar extends Component {
    ...
    render() {
        let {classes, fixed, currentUser} = this.props;
                  ...
                  <Icon>star_outline</Icon>
                        ...
                        <div className="flex items-center">
                            ...
                            <MatxMenu
                                menuButton={
                                    <React.Fragment>
                    <span className="cursor-pointer row" style={{color: 'white'}}>
                  <img
                      className="mx-2 align-middle circular-image-small"
                      src="/assets/images/face-6.jpg"
                      alt="user"
                  />{currentUser.username}<img
                        height="15px"
                        width="18px"
                        src={currentUser.avator ? currentUser.avator : "/assets/images/caret-icon-16.jpg"}
                        alt="user"
                    /></span>
                                    </React.Fragment>
                                }
...
const mapStateToProps = state => ({
    ...
    currentUser: state.user.data ? state.user.data : state.user
});
